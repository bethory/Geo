...
<body>
    ...
    <div class="col-xs-4">
        ...
        <form>
            <div class="form-group">
                <button class="btn btn-info" data-toggle="modal" data-target="#modal_tuto">
                    Videotutorial
                </button>
            </div>
            ...
            <div class="form-group" id="lista_redes">
                <label class="col-sm-4 control-label" for="formgroup">Red principal:</label>
                <select class="form-control" id="lista_redes">
                    <?php
            ...
            <div class="form-group">
                ...
                <div class="radio-inline">
                    <label>
                        <input type="radio" name="optionsRadios" id="radio_docentes"> Maestr@s
                    </label>
                </div>
            </div>
    ...
    <div class="modal fade" id="modal_tuto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
